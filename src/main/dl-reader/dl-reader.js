...
const getDataPoint = ({ bytesRead, buffer }) => {
  ...
  return {
    ...
    cLComp: buffer.readFloatLE(0x28),
    targetAFR: buffer.readFloatLE(0x30),
    targetLambda: buffer.readFloatLE(0x38),
    ...
    coolantAFROffset: buffer.readFloatLE(0x60),
    ...
    fuelEconomy: buffer.readFloatLE(0x88),
    fuelFlow: buffer.readFloatLE(0x90),
    mapROC: buffer.readFloatLE(0x98),
    tpsROC: buffer.readFloatLE(0xA0),
    tuningChange: buffer.readFloatLE(0xA8),
    estimatedVE: buffer.readFloatLE(0xB0),
    mainRevLimit: buffer.readFloatLE(0xB8),
    revLimit1: buffer.readFloatLE(0xC0),
    launchRetard: buffer.readFloatLE(0xC8),
    ignitionTiming: buffer.readFloatLE(0xD0),
    knockRetard: buffer.readFloatLE(0xD8),
    knockLevel: buffer.readFloatLE(0xE0),
    sparkPad2: buffer.readFloatLE(0xE8),
    iacPosition: buffer.readFloatLE(0xF0),
    targetIdleSpeed: buffer.readFloatLE(0xF8),
    map: buffer.readFloatLE(0x100),
    tps: buffer.readFloatLE(0x108),
    ...
    pedalPosition: buffer.readFloatLE(0x140),
  };
};
